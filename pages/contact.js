                ...
                <CardContent>
                  ...
                  <Box sx={{ display: "flex" }}>
                    ...
                    <Typography variant="h5" component="div" sx={{ ml: 1 }}>
                      <a
                        href="mailto:bhuiyan.azmal@du.ac.bd"
                        style={{ paddingLeft: "2px" }}
                      >
                        bhuiyan.azmal@du.ac.bd
                      </a>
                    </Typography>
                  </Box>
                </CardContent>
              ...
              <Card variant="outlined">
                <CardContent>
                  ...
                  <Box sx={{ display: "flex" }}>
                    ...
                    <Typography variant="h5" component="div" sx={{ ml: 1 }}>
                      <a
                        href="mailto:mkhondker@du.ac.bd"
                        style={{ paddingLeft: "2px" }}
                      >
                        mkhondker@du.ac.bd
                      </a>
          ...
          >
            <CardContent>
              ...
              <Typography sx={{ fontSize: 20 }} component="div">
                The project’s domain has been thought to create a help line to
                all types of users of the components of the Biodiversity of
                Bangladesh. To know the geographical distribution of a
                particular species on the geo-political map of Bangladesh
                including its various other features
              </Typography>
            </CardContent>
          </Card>
        </Grid>
