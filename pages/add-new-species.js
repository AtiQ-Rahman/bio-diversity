...
const AddNewSpecies = () => {
   ...
   async function fetchData(query, cbfn) {
      ...
      if (query?.category) {
         ...
         let species = await callApi('/get-species-by-serial', { searchParameters })
                              ...
                              <Grid item xs={2}>
                                 <Autocomplete
                                    ...
                                    renderInput={(params) => (
                                       <TextField
                                          {...params}
                                          error={Boolean(touched?.sub_species && errors?.sub_species)}
                                          helperText={touched?.sub_species && errors?.sub_species}
                                          style={{ padding: "2px" }}
                              ...
                              <Grid item xs={2}>
                                 <Autocomplete
                                    ...
                                    renderInput={(params) => (
                                       <TextField
                                          {...params}
                                          error={Boolean(touched?.sub_variety && errors?.sub_variety)}
                                          helperText={touched?.sub_variety && errors?.sub_variety}
                                          style={{ padding: "2px" }}
