      ...
      return (
        <Box height={400}>
          <Image
            ...
            objectFit="cover"
            loader={myLoader}
            src={`${imageUrl + "/" + speciesData?.additionalFiles[i]}`}
          />
        </Box>
      );
    },
        ...
        >
          ...
          <div className={styles.details_bar}>
            <Card sx={{ maxWidth: 345, height: 1080 }}>
              ...
              <Divider />
              <CardContent >
                <Typography gutterBottom variant="h1" component="div"  fontSize={25} fontFamily="Times New Roman" sx={{pt:6}}>
                  {speciesData?.name?.commonName}
                </Typography>
                <Typography variant="body2" color="text.secondary"   fontFamily="Times New Roman" sx={{pt:6}}>
