...
function createData(name, code, population, size) {
   ...
   return {
      name, code, population, size, density, history: [
         {
            date: '2020-01-05',
            customerId: '11091700',
            amount: 3,
         ...
         <>
            <TableRow hover role="checkbox" tabIndex={-1} key={row.id}>
               <TableCell>
                  ...
                  >
                     {openCategory ? <KeyboardArrowUpIcon /> : <KeyboardArrowDownIcon />}
                  </IconButton>
               </TableCell>
               {columns.map((column) => {
                  ...
                  <Box component="section" className={styles.main_box}>
                     ...
                     <Grid container item xs={12} md={12} sx={{ mx: "auto" }}>
                        <Grid item xs={12} md={12}>
                           ...
                           >
                              <Paper sx={{ width: '100%', overflow: 'hidden' }} component={Paper}>
                  ...
                  <DialogContent dividers>
                     <Formik
                        ...
                        onSubmit={async (
                           ...
                           try {
                              console.log(values);
                              if (!values.name || !values.type || values.keyList.length == 0) {
                                 return
                              }
                              ...
                              let response = await callApi('/add-update-categories', data)
                              resetForm()
                           } catch (error) {
                              console.log({ error });
                                 ...
                                 <Grid container xs={12} md={12}>
                                    {values?.keyList.map((item, index) => {
                                       return (
                                          ...
                                          <Grid item xs={12} key={`keyList${index}`} md={12} sx={{ display: "flex", mb: 2 }}>
                                             <TextField
                                                type="text"
                                                size="small"
                                             ...
                                             />
                                             <Icon icon="fluent:delete-28-filled" width={30} color="red" onClick={(e) => {
