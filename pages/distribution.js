...
const Distribution = () => {
  ...
  useEffect(() => {
    ...
    modifiedList.map((city) => {
      if (
        city.marker &&
        city.districts[0].center[0] &&
        city.districts[0].center[1]
      ) {
        console.log({ city });
        ...
        let marker = new mapboxgl.Marker(el)
          ...
          .setPopup(
            new mapboxgl.Popup({ offset: 30 }).setHTML(`
                        <div >
                        <div style="height: 150px; width:150px;padding:100px;margin:8px;background-image: url('${
                          imageUrl + "/" + city.profile_image
                        ...
                        <div className="popup">
                            ...
                            <p className="route-city">Lng/Lat ${
                              city.districts[0].center[0]
                            },${city.districts[0].center[1]}</p>
                        </div>
                    </div>`)
          )
          .addTo(map.current);
